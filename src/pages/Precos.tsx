  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: '149 templates de laudo', included: true },
        { text: '400 frases modelo', included: true },
        { text: '100+ tabelas de referência', included: true },
        { text: '25 calculadoras médicas', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: '149 templates + 400 frases', included: true },
        { text: '100+ tabelas + 25 calculadoras', included: true },
        { text: 'Dicionário médico (4.300+ termos)', included: true },
        { text: 'IA Conclusão (2 tokens/uso)', included: true },
        { text: 'IA Sugestões (1 token/uso)', included: true },
        { text: 'IA RADS (2 tokens/uso)', included: false },
        { text: 'Suporte prioritário', included: false }
      ],
      cta: 'Assinar Básico',
      href: '/signup',
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Dicionário médico (4.300+ termos)', included: true },
        { text: 'IA Conclusão (2 tokens/uso)', included: true },
        { text: 'IA RADS (2 tokens/uso)', included: true },
        { text: '50 créditos Whisper/mês', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'IA Conclusão (2 tokens/uso)', included: true },
        { text: 'IA RADS (2 tokens/uso)', included: true },
        { text: '200 créditos Whisper/mês', included: true },
        { text: 'Tokens extras: R$ 0,08/token', included: true },
