-- Corrigir a RPC get_platform_metrics: substituir coluna inexistente 'codigo' por 'categoria'
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'tables_count', (SELECT COUNT(*) FROM (SELECT DISTINCT categoria FROM rads_text_options WHERE ativo = true) t),
