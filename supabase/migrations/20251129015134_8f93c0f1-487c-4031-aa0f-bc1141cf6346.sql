-- Fase 1 e 2: Migração de Templates de Esteatose para Condições Lógicas
-- Adiciona sistema de derivação automática de achados baseado no grau selecionado

-- FASE 1: USG_ABDOME_TOTAL_ESTEATOSE_COLECISTECTOMIA
...
Alças intestinais sem particularidades.',
  ...
  impressao = 'Esteatose hepática {{impressao_grau}}. Colecistectomia.',
...
-- FASE 2: USG_ABDOME_TOTAL_HEPATOPATIA_DEPOSITO
UPDATE system_templates SET
  achados = 'Fígado de topografia e morfologia normais, contornos regulares, {{achados_figado}}.

Veias hepáticas e veias do sistema porta pérvias e de calibre preservado.
