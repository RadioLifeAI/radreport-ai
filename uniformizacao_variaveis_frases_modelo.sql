...
-- 2. Selecione o projeto "gxhbdbovixbptrjrcwbr"
-- 3. Vá em "SQL Editor" no menu lateral
-- 4. Crie uma nova query
-- 5. Cole todo o conteúdo deste arquivo
-- 6. Execute clicando em "Run" ou pressionando Ctrl+Enter
-- 7. Verifique se todas as queries foram executadas com sucesso
-- 8. Recarregue o editor no frontend para ver as mudanças
